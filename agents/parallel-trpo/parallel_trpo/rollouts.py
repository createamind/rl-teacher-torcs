...
class Actor(multiprocess.Process):
    def __init__(self, task_q, result_q, env_id, max_timesteps_per_episode):
    ...
    def run(self):
        ...
        hidden_size = 200
        action_size = 2
        self.env = AgentTorcs2(self.env_id, bots=['scr_server'], track='road/g-track-1', text_mode=False, laps=3,
                          torcsIdxOffset=100, screen_capture=True)
...
class ParallelRollout(object):
    def __init__(self,  reward_predictor, num_workers, max_timesteps_per_episode, seed):
        ...
        for i in range(self.num_workers):
            ...
            self.actors.append(Actor(self.tasks_q, self.results_q, i, max_timesteps_per_episode))
