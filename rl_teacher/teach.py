...
class TorcsEnv(AgentTorcs2):
    def __init__(self,*args,**kwargs):
        super(TorcsEnv, self).__init__(*args,**kwargs)
...
class ComparisonRewardPredictor():
    ...
    def __init__(self, summary_writer, comparison_collector, agent_logger, label_schedule):
